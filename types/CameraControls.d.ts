declare class CameraControls extends EventDispatcher {
    ...
    protected _viewport: THREE.Vector4 | null;
    ...
    protected _elementRect: THREE.Vector4;
    ...
    fitToBox(box3OrObject: THREE.Box3 | THREE.Object3D, enableTransition: boolean, { paddingLeft, paddingRight, paddingBottom, paddingTop }?: Partial<FitToOptions>): void;
    fitTo(box3OrObject: THREE.Box3 | THREE.Object3D, enableTransition: boolean, fitToOptions?: Partial<FitToOptions>): void;
    fitToSphere(sphereOrMesh: THREE.Sphere | THREE.Object3D, enableTransition: boolean): void;
